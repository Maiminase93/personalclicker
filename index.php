...
<body>
    ...
    <!-- Panel auxiliar muestra GIPHY API -->
    <section id="gif">
        <h3 style="display: none;">GIPHY API Exito en 🌱PlantWorld</h3>
     </section>
    ...
    <footer style="display: none;">
        <h2>Jafet Armadans</h2>
        <p>Projecte Final - CIFO La Violeta - Confecció i publicació de pàgines web</p>
    </footer>
    <!-- Scripts -->
